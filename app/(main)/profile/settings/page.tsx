...
export default function Settings() {
  ...
  return (
    <main style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: 1 }}>
              ...
              <span style={{ fontSize: '16px', color: '#1c1e21', fontWeight: '600' }}>ປ່ຽນອີເມລ</span>
            </div>
          </div>

          {/* เมนู ຂໍ້ກຳນົດ ແລະ ນະໂຍບາຍ */}
          <div 
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: 1 }}>
              ...
              <span style={{ fontSize: '16px', color: '#1c1e21', fontWeight: '600' }}>ຂໍ້ກຳນົດ ແລະ ນະໂຍບາຍ</span>
            </div>
          </div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: 1 }}>
              ...
              <span style={{ fontSize: '16px', color: '#1c1e21', fontWeight: '600' }}>ລາຍງານບັນຫາ</span>
            </div>
          </div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: 1 }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="#4b5563" stroke="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span style={{ fontSize: '16px', color: '#1c1e21', fontWeight: '600' }}>
      ...
      {/* ปุ่มออกจากระบบ */}
      <div style={{ padding: '40px 20px 20px 20px', marginTop: 'auto', display: 'flex', justifyContent: 'center' }}>
        <button 
