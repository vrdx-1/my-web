...
export interface SavedFeedBlockProps {
...
/**
 * Feed สำหรับหน้า saved — ไม่ใช้ PostFeed เลย เพื่อหลีกเลี่ยง React 19 "Expected static flag was missing"
 * เรนเดอร์ PostCard โดยตรง + EmptyState + bottom slot
 */
export function SavedFeedBlock(props: SavedFeedBlockProps) {
  const {
    showSkeleton,
    skeletonCount,
    posts,
