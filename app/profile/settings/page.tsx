  ...
  return (
    <main style={{ 
      ...
      <div style={{ 
        ...
        <h1 style={{ fontSize: '18px', fontWeight: 'bold', marginLeft: '15px', color: '#1c1e21' }}>ຕັ້ງຄ່າ</h1>
      </div>

      {/* ส่วนเนื้อหาหลัก */}
      <div style={{ padding: '20px', flex: 1 }}>
        
        <div style={{ background: '#fff', borderRadius: '12px', overflow: 'hidden', border: '1px solid #eee', marginBottom: '20px' }}>
          ...
          >
            <span style={{ fontSize: '15px', color: '#1c1e21', fontWeight: '500' }}>ປ່ຽນລະຫັດຜ່ານ</span>
          ...
          {/* แก้ไขส่วน: ຕິດຕໍ່ທີມງານ Projeg (กดได้ทั้งแถว) */}
          <a 
            href="https://wa.me/8562056414176" 
            target="_blank" 
          ...
          >
            <span style={{ fontSize: '15px', color: '#1c1e21', fontWeight: '500' }}>
              ຕິດຕໍ່ທີມງານ Projeg 02056414176
            </span>
