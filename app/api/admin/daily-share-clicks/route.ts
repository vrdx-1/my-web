...
/**
 * GET /api/admin/daily-share-clicks?year=2026
 * คืนข้อมูลจำนวนการกดแชร์แบบรายวัน
 */
export async function GET(request: NextRequest) {
  ...
  if (queryRes.error) {
    return internalServerError('admin/daily-share-clicks query failed', queryRes.error);
  }
