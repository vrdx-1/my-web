 ...
 */
export const POST_SELECT_FIELDS = 'id, caption, province, price, price_currency, approx_price_lak, approx_price_thb, approx_price_usd, images, status, created_at, is_boosted, is_hidden, user_id, guest_token, is_guest, layout, short_id';
 ...
 */
export const POST_MINIMAL_SELECT = 'id, caption, province, price, price_currency, approx_price_lak, approx_price_thb, approx_price_usd, images, status, created_at, is_boosted, user_id, short_id';
